...
set "FILES[0]=main_pyproject.windows-cpu.toml|..\Software|pyproject.toml"
...
set "FILES[3]=stableaudio3_pyproject.windows-cpu.toml|..\Software\AI_Sound\StableAudio3|pyproject.toml"
set "FILES[4]=mediapipe_pyproject.windows-cpu.toml|..\Software\AI_Motion\MotionTracking\Mediapipe|pyproject.toml"
set "FILES[5]=yolo_pyproject.windows-cpu.toml|..\Software\AI_Motion\MotionTracking\Yolo|pyproject.toml"
set "FILES[6]=bark_tts_pyproject.windows_cpu.toml|..\Software\AI_Sound\BarkTTS|pyproject.toml"
set "FILES[7]=dancediffusion_pyproject_windows_cpu.toml|..\Software\AI_Sound\DanceDiffusion|pyproject.toml"
